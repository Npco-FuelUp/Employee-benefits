...
const companies = [
    ...
    { name: "صيدليات وياك", nameEn: "Wayak Pharmacies", logo: "images/Wayak.svg", discount: "15%", category: "صيدليات", categoryEn: "Pharmacies", url: "https://wayakcard.com/", validUntil: "31 ديسمبر 2026", validUntilEn: "December 31, 2026", description: "عروض حصرية عبر واتساب! اطلب الآن عبر الأرقام (01103452309 - 01111583361) واحصل على خصم 15% على الأدوية المحلية و5% على الأدوية المستوردة.", descriptionEn: "Exclusive WhatsApp Offer! Order via (01103452309 - 01111583361) and get 15% OFF on local medications and 5% OFF on imported medications.", discountCode: "WAYAK15" },
    { name: "دكان", nameEn: "Dokkan", logo: "images/Dokkan.svg", discount: "20%", category: "مراكز صيانة", categoryEn: "Auto Service Centers", url: "https://dokkanauto.com/services/", validUntil: "31 ديسمبر 2026", validUntilEn: "December 31, 2026", description: "خصم 20% على مصنعية جميع خدمات المركز (بحد أقصى 1000 جنيه).", descriptionEn: "Enjoy 20% OFF on labor fees across all service center solutions (up to EGP 1,000).", discountCode: "DOKKAN20" },
];
...
const categoryTranslations = {
  ar: ["الكل", "صيدليات", "ملابس", "مطاعم", "مراكز صيانة"],
  en: ["All", "Pharmacies", "Clothing", "Restaurants", "Auto Service Centers"],
};
